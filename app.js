...
function openRecordingHelperDialog() {
  elements.recordingHelperWebVersion.textContent = `WEB v${WEBSITE_VERSION}`;
  elements.recordingHelperVersion.textContent = `HELPER v${RECORDER_HELPER_VERSION}`;
  elements.recordingHelperDownloadVersion.textContent = `HELPER v${RECORDER_HELPER_VERSION}`;
  elements.recordingHelperCompatibility.textContent = `兼容助手：${RECORDER_HELPER_COMPATIBILITY.label}`;
